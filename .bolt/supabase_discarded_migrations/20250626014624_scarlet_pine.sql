/*
  # Corregir configuración del sistema y cálculos de ganancias

  1. Arreglar constraint único en configuracion_sistema
  2. Corregir función de estadísticas de admin
  3. Implementar cálculo correcto de ganancias según especificaciones
  4. Agregar configuración de porcentajes dinámicos
*/
...
-- Función para obtener distribución de partners con cálculo correcto según especificaciones
...
BEGIN
  ...
  LOOP
    DECLARE
      v_ganancia_individual NUMERIC;
    BEGIN
      -- Calcular ganancia individual: 70% del 5% de su inversión
      v_ganancia_individual := (v_inversor.total * v_porcentaje_ganancia * v_porcentaje_inversores) / 10000;
