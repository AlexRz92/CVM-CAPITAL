...
DROP FUNCTION IF EXISTS obtener_distribucion_partners_preview(numeric, numeric, numeric);
DROP FUNCTION IF EXISTS obtener_distribucion_inversores_preview(numeric, numeric, numeric);
...
DROP FUNCTION IF EXISTS validar_eliminacion_partner(uuid);
...
-- Políticas básicas (permitir acceso completo)
CREATE POLICY "Allow all operations" ON inversores FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON partners FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON admins FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON transacciones FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON partner_transacciones FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON solicitudes FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON partner_solicitudes FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON partner_inversores FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON configuracion_sistema FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON ganancias_semanales FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON partner_ganancias FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON notificaciones FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON avisos FOR ALL TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON tickets FOR ALL TO public USING (true) WITH CHECK (true);
...
BEGIN
  ...
  SELECT 
    ...
    CASE 
      WHEN p.tipo = 'operador_partner' THEN 
        -- Ganancia como operador: 50% adicional del 30% de sus inversores
...
BEGIN
  ...
  LOOP
    IF v_partner.tipo = 'operador_partner' THEN
      ...
      v_ganancia_operador := v_partner.monto_total_inversores * 0.05 * 0.30 * 0.50;
    ELSE
...
-- =============================================
-- FUNCIONES DE TICKETS Y NOTIFICACIONES
-- =============================================
...
/*
  ...
  ✅ Políticas RLS permisivas para evitar errores 42501
  ✅ Triggers automáticos para procesar solicitudes
  ✅ Todas las funciones que usa el frontend incluidas
