...
const PartnerStatsCards: React.FC<PartnerStatsCardsProps> = ({ partner, ganancias }) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      {partner.tipo === 'operador_partner' && (
        <div className="md:col-span-2 lg:col-span-4 bg-yellow-400/20 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-cyan-200/50">
          <h3 className="text-lg font-bold text-white mb-4">Desglose de Ganancias</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/10 rounded-lg p-4">
              <h4 className="text-white/80 text-sm font-medium mb-2">Ganancia como Partner</h4>
