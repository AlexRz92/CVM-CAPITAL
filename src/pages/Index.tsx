...
const Index: React.FC = () => {
  ...
  if (userLoading || partnerLoading || maintenanceLoading) {
    return (
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-cyan-700 via-blue-400 to-blue-800">
              ...
              <div className="text-white/90 space-y-4">
                <div>
                  ...
                  <ul className="space-y-1 text-sm">
                    <li>• Monto mínimo: USD 500 (Depósito de incio)</li>
        ...
        <style jsx>{`
          ...
          .animate-slide-in-left-delay { animation: slide-in-left 0.8s ease-out 0.5s both; }
          .animate-slide-in-right-delay { animation: slide-in-right 0.8s ease-out 0.6s both; }
          .animate-fade-in-up { animation: fade-in-up 0.8s ease-out 0.7s both; }
